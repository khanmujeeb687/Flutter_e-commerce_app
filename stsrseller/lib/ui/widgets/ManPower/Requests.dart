...
class _RequestsState extends State<Requests> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Requests",style: GoogleFonts.muli(),),
      ),
      body: Container(
                      ...
                      Card(
                        child: Container(
                          child: IconButton(
                            ...
                            onPressed: ()async{
                              String url = "tel:${_servicedata[index]['phone']}";
                      ...
                      Card(
                        child: Container(
                          child: IconButton(
                            ...
                            onPressed: ()async{
                              String url = "sms:+91 ${_servicedata[index]['phone']}";
                              if (await canLaunch(url)) {
                                await launch(url);
                              } else {
                                throw 'Could not launch $url';
                      ...
                      Card(
                        child: Container(
                          child: IconButton(
                            ...
                            onPressed: () async{
                              String url = "whatsapp://send?phone=+91 ${_servicedata[index]['phone']}";
                              if (await canLaunch(url)) {
                                await launch(url);
                              } else {
                                throw 'Could not launch $url';
  ...
  _shimmer(){
    return SpinKitDoubleBounce(color: LightColor.orange,);
  }
